...
export const PhoneNumberQuestionCard = ({ questionId }: Props) => {
  ...
  return (
    <QuestionCreationCard
      ...
      optionSettings={<PhoneNumberQuestionCardOptions questionId={questionId} />}
    />
  );
};

const PhoneNumberQuestionCardOptions = ({ questionId }: { questionId: string }) => {
